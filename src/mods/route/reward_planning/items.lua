...
local function appendItem(items, row, source, address, sourceKind, sourceIndex)
    ...
    items[#items + 1] = {
        ...
        eligibleRewardTypes = source.eligibleRewardTypes,
        ineligibleRewardTypes = source.ineligibleRewardTypes,
...
local function appendPrebossRoomStoreItem(items, row, source, offer, sourceKind, sourceIndex)
    items[#items + 1] = {
        ...
        eligibleRewardTypes = offer.eligibleRewardTypes,
        ineligibleRewardTypes = offer.ineligibleRewardTypes,
