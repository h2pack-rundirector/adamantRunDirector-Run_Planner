...
local function appendPrebossRewardControls(definitions, offer, controls, godValues, godLabels)
    ...
    local rewardTypes = common.bundleOptions(definitions, offer.rewardStore)
    local eligible = common.lookupList(offer.eligibleRewardTypes)
    local ineligible = common.lookupList(offer.ineligibleRewardTypes)
