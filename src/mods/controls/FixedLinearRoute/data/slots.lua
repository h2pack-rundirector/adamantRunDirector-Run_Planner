...
local function buildFixedRoleSlot(instance, ordinal, special)
    ...
    local role = {
        ...
        rewardBearingExitCount = fixedRoomField(special, "rewardBearingExitCount"),
    ...
    instance.routeSlots[rowIndex] = applySlotDepthContext({
        ...
        roomHistoryCost = special.roomHistoryCost,
        roleKey = role.key,
        role = role,
        features = features,
    }, {
...
local function buildEntrySlot(instance, entry)
    ...
    buildFixedRoleSlot(instance, entry.routeOrdinal or 0, {
        ...
        rewardBearingExitCount = entry.rewardBearingExitCount,
