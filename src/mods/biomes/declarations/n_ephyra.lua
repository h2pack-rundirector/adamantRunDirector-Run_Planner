    ...
    rooms = {
        ...
        },
        {
            ...
            eligibility = {
                ...
                roomKeys = { "N_PreHub01" },
                code = "n_hub_target_requires_pre_hub",
            },
            terminal = false,
            fixed = false,
            localChildren = {},
            ...
            localChildren = {
                {
                    ...
                    kind = "sideRoom",
                    ordinal = 1,
                    rewardSurfaceKey = "SubRoomReward",
                },
                {
                    doorId = 558352,
                    gameRoomKey = "N_Sub03",
            ...
            localChildren = {
                {
                    ...
                    kind = "sideRoom",
                    ordinal = 1,
                    rewardSurfaceKey = "SubRoomHardReward",
                },
                {
                    doorId = 560794,
                    gameRoomKey = "N_Sub05",
        ...
        },
        {
            ...
            tags = {},
            exits = { { index = 1, targetMode = "generated", type = "EphyraExitDoorReturn" } },
            rewardSurfaceKey = "HubRewardNoHammerHermes",
            encounterProfileKey = "EphyraCombat",
            counters = { biomeDepthCache = 1, roomHistoryOrdinal = 1 },
            caps = {},
            eligibility = {
        ...
        },
        {
            ...
            eligibility = {
                ...
                comparison = "==",
                value = 6,
                code = "n_preboss_requires_six_pylons",
            },
            terminal = true,
            fixed = true,
            localChildren = {},
