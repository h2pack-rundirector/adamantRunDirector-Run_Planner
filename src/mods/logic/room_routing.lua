...
local function counterSummary(currentRun, planned)
    return " actualRunDepth=" .. fieldValue(runState.runDepthCache(currentRun))
        ...
        .. " simRunEncounterDepthMin=" .. fieldValue(planned and planned.runEncounterDepthMin)
        .. " simRunEncounterDepthMax=" .. fieldValue(planned and planned.runEncounterDepthMax)
        ...
        .. " simBiomeEncounterDepthMin=" .. fieldValue(planned and planned.biomeEncounterDepthMin)
        .. " simBiomeEncounterDepthMax=" .. fieldValue(planned and planned.biomeEncounterDepthMax)
end
...
local function rowSummary(biomeKey, row)
    return "plan row biome=" .. tostring(biomeKey)
        ...
        .. " runEncounterDepthMin=" .. fieldValue(row.runEncounterDepthMin)
        .. " runEncounterDepthMax=" .. fieldValue(row.runEncounterDepthMax)
