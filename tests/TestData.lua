...
function TestRunPlannerData.testBiomeDefinitionsDeclareNaturalChaosFeatures()
    ...
    lu.assertEquals(biomes.lookup.G.slotLayout.entry.room.features, chaos)
    ...
    lu.assertEquals(biomes.lookup.N.slotLayout.fixedBeforeHub[1].room.features, chaos)
    ...
    lu.assertEquals(biomes.lookup.P.slotLayout.entry.room.features, chaos)
...
function TestRunPlannerData.testEphyraCombatRoomsDeclareLocationAndDifficulty()
    ...
    lu.assertEquals(optionByKey(combat, "N_Combat05").enrichmentColor, { 0.35, 0.9, 0.45, 1.0 })
    lu.assertEquals(optionByKey(combat, "N_Combat06").enrichmentColor, { 0.25, 0.85, 1.0, 1.0 })
    lu.assertEquals(optionByKey(combat, "N_Combat19").location, "W")
    lu.assertEquals(optionByKey(combat, "N_Combat19").difficulty, 4)
    lu.assertEquals(optionByKey(combat, "N_Combat19").enrichmentColor, { 0.72, 0.46, 1.0, 1.0 })
    ...
    lu.assertEquals(optionByKey(combat, "N_Combat01").enrichmentColor, { 1.0, 0.78, 0.18, 1.0 })
end
...
function TestRunPlannerData.testBiomeDefinitionsDeclareDepthSpecials()
    ...
    lu.assertEquals(fPreboss.kind, "preboss")
    lu.assertNil(fPreboss.room)
    ...
    lu.assertEquals(gIntro.room.key, "G_Intro")
    ...
    lu.assertEquals(gPreboss.kind, "preboss")
    lu.assertNil(gPreboss.room)
    lu.assertEquals(gPreboss.label, "Preboss")
    lu.assertEquals(gPreboss.reward, prebossReward("WorldShop"))

    lu.assertEquals(biomes.lookup.H.slotLayout.fixedBeforeRoute[1].room.key, "H_Intro")
    ...
    lu.assertEquals(oIntro.room.key, "O_Intro")
    ...
    lu.assertEquals(pIntro.room.key, "P_Intro")
    ...
    lu.assertEquals(pPreboss.kind, "preboss")
    lu.assertNil(pPreboss.room)
    ...
    lu.assertEquals(qIntro.room.key, "Q_Intro")
    ...
    lu.assertEquals(qPreboss.kind, "preboss")
    lu.assertNil(qPreboss.room)
    ...
    lu.assertEquals(oPreboss.kind, "preboss")
    lu.assertNil(oPreboss.room)
...
function TestRunPlannerData.testBiomeDefinitionsDeclareRoleCapabilities()
    ...
    lu.assertNil(biomes.lookup.P.slotLayout.special[9].tags)
...
function TestRunPlannerData.testEphyraHubLayoutModelsPylonRoute()
    ...
    lu.assertNil(ephyra.slotLayout.fixedAfterHub[1].room)
